...
> Lightweight utility logger compiling queries, search metadata, and token completion counts.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/rag-logger/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-rag-logger.git
cd tp-rag-logger
```
...
```bash
kubectl port-forward deployment/tp-rag-logger 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── rag_logger.py     # Main configuration file
```
...
---
*Generated by [RAG Logger Studio](https://pradeeptalari14.github.io/portfolio/tools/rag-logger/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
